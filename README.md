...
The PDF-format documentation is available as releases. 
Other documents will be added gradually (still in the form of releases).

Please note that for now all the documents are in French.
Their translation is planned and will be released as soon as possible.
